  ...
  renderContent() {
    return (
      <div className="container">
        <PageTitle title="Privacy Policy" type="type2"/>
        <ContentCard className="static-page">
          <h3 className="content-title">Your privacy is important to us.</h3>
          <p>It is APPII Pty Ltd&apos;s policy to respect your privacy regarding any information we may collect while
            operating our website. Accordingly, we have developed this privacy policy in order for you to understand how
            we collect, use, communicate, disclose and otherwise make use of personal information. We have outlined our
          ...
          <ul type="disc" className="list-disc">
            ...
            <li>We will collect and use personal information solely for fulfilling those purposes specified by us and
              for other ancillary purposes, unless we obtain the consent of the individual concerned or as required by
              law.
            </li>
          ...
          <p>We are committed to conducting our business in accordance with these principles in order to ensure that the
            confidentiality of personal information is protected and maintained. APPII Pty Ltd may change this privacy
            policy from time to time at APPII Pty Ltd&apos;s sole discretion.</p>
        </ContentCard>
      </div>
    )
  }
